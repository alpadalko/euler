  function Euler() {
    ...
    function row() {
      ...
      for (let rowsNum = 0; rowsNum < h; rowsNum += 1) {
        for (let lastNum = 3; lastNum < matrix[rowsNum].length; lastNum += 1) {
          const product_of_four_consecutive_numbers = matrix[rowsNum][lastNum]
